...
export default function Home({ setActiveView }) {
    ...
    useEffect(() => {
        // We simuleren even een snelle check hoeveel bots er leven voor de landing page stats.
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center relative overflow-hidden bg-[#0b0e11] grid-background scanline-effect p-6">
            ...
            <div className="z-10 flex flex-col items-center text-center fade-in max-w-4xl">
                
                {/* Hero Title */}
                <div className="mb-8 p-6 rounded-2xl bg-[#181a20]/80 backdrop-blur-xl border border-[#2b3139] glow-panel">
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-widest text-white drop-shadow-lg mb-2">
                        APEX<span className="text-[#fcd535]">ALGO</span>
                    </h1>
                    <p className="text-[#0ea5e9] text-xs md:text-sm font-mono tracking-[0.3em] uppercase">Quantitative Trading Engine v3.0</p>
                </div>

                <p className="text-[#848e9c] text-base md:text-lg mb-12 max-w-2xl leading-relaxed">
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
                    <button 
                        ...
                        className="px-8 py-4 bg-[#fcd535] text-[#181a20] font-bold uppercase tracking-wider rounded shadow-[0_0_15px_rgba(252,213,53,0.3)] hover:shadow-[0_0_25px_rgba(252,213,53,0.5)] hover:bg-[#e5c02a] transition-all transform hover:-translate-y-1"
                    >
                        Launch Architecture Builder
                    </button>
                    <button 
                        onClick={() => setActiveView('manager')}
                        className="px-8 py-4 bg-transparent border border-[#2b3139] text-[#eaecef] font-bold uppercase tracking-wider rounded hover:border-[#848e9c] hover:bg-[#181a20] transition-colors"
                    >
                        Enter Data Vault
                    </button>
                </div>
